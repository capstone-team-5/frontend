  ...
  return (
    <div className="sm:px-8 md:px-24 py-12 dark:bg-gray-900">
      <div className="flex flex-col dark:bg-gray-900">
        <div className="bg-transparent bg-cover bg-[url(https://as2.ftcdn.net/v2/jpg/03/54/09/73/1000_F_354097363_uiVqyyDcb4ujwJBIuHKhuK8d6V9yX78H.jpg)] bg-gray-700 bg-blend-multiply ">
